...
function Header(_ref) {
  ...
  return __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_5__["Container"], {
    maxWidth: "xl",
    className: "container",
    style: {
      paddingLeft: 0,
    ...
    return __jsx(next_link__WEBPACK_IMPORTED_MODULE_1___default.a, {
      ...
      className: "jsx-".concat(_styles__WEBPACK_IMPORTED_MODULE_3__["default"].__hash) + " " + "".concat(router.asPath.substring(1) === category.slug ? "active" : "", " vertically fitted item"),
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 43,
...
//# sourceMappingURL=index.js.61e6e03c1cf4305d3913.hot-update.js.map