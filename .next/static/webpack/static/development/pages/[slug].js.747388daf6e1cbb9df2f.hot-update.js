...
var BlogComponent = function BlogComponent(_ref) {
  ...
  }, data.title.toUpperCase()), data.tags.map(function (tag) {
    return __jsx("button", {
      className: "jsx-".concat(_styles__WEBPACK_IMPORTED_MODULE_2__["default"].__hash) + " " + "ui ".concat(Object(_utils_constants__WEBPACK_IMPORTED_MODULE_4__["randomColor"])(), " button"),
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 21,
...
//# sourceMappingURL=[slug].js.747388daf6e1cbb9df2f.hot-update.js.map